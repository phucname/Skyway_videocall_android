...
namespace Org.Webrtc {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.webrtc']/class[@name='Camera1Capturer']"
	[global::Android.Runtime.Register ("org/webrtc/Camera1Capturer", DoNotGenerateAcw=true)]
	public partial class Camera1Capturer : global::Java.Lang.Object {
		static readonly JniPeerMembers _members = new XAPeerMembers ("org/webrtc/Camera1Capturer", typeof (Camera1Capturer));
		...
		protected Camera1Capturer (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.webrtc']/class[@name='Camera1Capturer']/constructor[@name='Camera1Capturer' and count(parameter)=3 and parameter[1][@type='java.lang.String'] and parameter[2][@type='org.webrtc.CameraVideoCapturer.CameraEventsHandler'] and parameter[3][@type='boolean']]"
		[Register (".ctor", "(Ljava/lang/String;Lorg/webrtc/CameraVideoCapturer$CameraEventsHandler;Z)V", "")]
		public unsafe Camera1Capturer (string? cameraName, global::Org.Webrtc.ICameraVideoCapturer.ICameraEventsHandler? eventsHandler, bool captureToTexture) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "(Ljava/lang/String;Lorg/webrtc/CameraVideoCapturer$CameraEventsHandler;Z)V";

			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;

			IntPtr native_cameraName = JNIEnv.NewString ((string?)cameraName);
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [3];
				__args [0] = new JniArgumentValue (native_cameraName);
				__args [1] = new JniArgumentValue ((eventsHandler == null) ? IntPtr.Zero : ((global::Java.Lang.Object) eventsHandler).Handle);
				__args [2] = new JniArgumentValue (captureToTexture);
...
#pragma warning disable 0169
		static Delegate GetGetCameraNameHandler ()
		{
			if (cb_getCameraName == null)
				cb_getCameraName = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetCameraName);
			return cb_getCameraName;
		}

		static IntPtr n_GetCameraName (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.Camera1Capturer> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
			return JNIEnv.NewString (__this.CameraName);
		}
#pragma warning restore 0169

		protected virtual unsafe string? CameraName {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.webrtc']/class[@name='Camera1Capturer']/method[@name='getCameraName' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe bool IsScreencast {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.webrtc']/class[@name='Camera1Capturer']/method[@name='isScreencast' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.webrtc']/class[@name='Camera1Capturer']/method[@name='changeCaptureFormat' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.webrtc']/class[@name='Camera1Capturer']/method[@name='dispose' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.webrtc']/class[@name='Camera1Capturer']/method[@name='initialize' and count(parameter)=3 and parameter[1][@type='org.webrtc.SurfaceTextureHelper'] and parameter[2][@type='android.content.Context'] and parameter[3][@type='org.webrtc.CapturerObserver']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.webrtc']/class[@name='Camera1Capturer']/method[@name='printStackTrace' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.webrtc']/class[@name='Camera1Capturer']/method[@name='startCapture' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.webrtc']/class[@name='Camera1Capturer']/method[@name='stopCapture' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.webrtc']/class[@name='Camera1Capturer']/method[@name='switchCamera' and count(parameter)=1 and parameter[1][@type='org.webrtc.CameraVideoCapturer.CameraSwitchHandler']]"
		...
		public virtual unsafe void SwitchCamera (global::Org.Webrtc.ICameraVideoCapturer.ICameraSwitchHandler? p0)
		{
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.webrtc']/class[@name='Camera1Capturer']/method[@name='switchCamera' and count(parameter)=2 and parameter[1][@type='org.webrtc.CameraVideoCapturer.CameraSwitchHandler'] and parameter[2][@type='java.lang.String']]"
		...
		public virtual unsafe void SwitchCamera (global::Org.Webrtc.ICameraVideoCapturer.ICameraSwitchHandler? p0, string? p1)
		{
