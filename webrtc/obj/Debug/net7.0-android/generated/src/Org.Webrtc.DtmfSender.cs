...
namespace Org.Webrtc {
	...
	public partial class DtmfSender : global::Java.Lang.Object {
		...
		[Register (".ctor", "(J)V", "")]
		public unsafe DtmfSender (long nativeDtmfSender) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		static Delegate GetCanInsertDtmfHandler ()
		{
			if (cb_canInsertDtmf == null)
				cb_canInsertDtmf = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_Z) n_CanInsertDtmf);
			return cb_canInsertDtmf;
		}

		static bool n_CanInsertDtmf (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.DtmfSender> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning disable 0169
		...
		{
			if (cb_duration == null)
				cb_duration = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_I) n_Duration);
			return cb_duration;
		}
...
#pragma warning disable 0169
		static Delegate GetInsertDtmf_Ljava_lang_String_IIHandler ()
		{
			if (cb_insertDtmf_Ljava_lang_String_II == null)
				cb_insertDtmf_Ljava_lang_String_II = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPLII_Z) n_InsertDtmf_Ljava_lang_String_II);
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.DtmfSender> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
			var tones = JNIEnv.GetString (native_tones, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe bool InsertDtmf (string? tones, int duration, int interToneGap)
		{
			...
			IntPtr native_tones = JNIEnv.NewString ((string?)tones);
			try {
...
#pragma warning disable 0169
		static Delegate GetInterToneGapHandler ()
		{
			if (cb_interToneGap == null)
				cb_interToneGap = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_I) n_InterToneGap);
...
#pragma warning disable 0169
		...
		{
			if (cb_tones == null)
				cb_tones = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_Tones);
			return cb_tones;
		}
