...
namespace Org.Webrtc {
	...
	public partial class GlTextureFrameBuffer : global::Java.Lang.Object {
		...
		[Register (".ctor", "(I)V", "")]
		public unsafe GlTextureFrameBuffer (int pixelFormat) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		static Delegate GetGetFrameBufferIdHandler ()
		{
			if (cb_getFrameBufferId == null)
				cb_getFrameBufferId = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_I) n_GetFrameBufferId);
			return cb_getFrameBufferId;
		}

		static int n_GetFrameBufferId (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.GlTextureFrameBuffer> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning disable 0169
		static Delegate GetSetSize_IIHandler ()
		{
			if (cb_setSize_II == null)
				cb_setSize_II = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPII_V) n_SetSize_II);
