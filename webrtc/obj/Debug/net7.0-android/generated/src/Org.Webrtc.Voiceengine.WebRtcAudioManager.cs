...
#pragma warning disable 0169
		static Delegate GetIsLowLatencyInputSupportedHandler ()
		{
			if (cb_isLowLatencyInputSupported == null)
				cb_isLowLatencyInputSupported = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_Z) n_IsLowLatencyInputSupported);
			return cb_isLowLatencyInputSupported;
		}

		static bool n_IsLowLatencyInputSupported (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.Voiceengine.WebRtcAudioManager> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
