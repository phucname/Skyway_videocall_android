...
namespace Org.Webrtc {
	...
	public partial class AudioTrack : global::Org.Webrtc.MediaStreamTrack {
		...
		[Register (".ctor", "(J)V", "")]
		public unsafe AudioTrack (long nativeTrack) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		static Delegate GetSetVolume_DHandler ()
		{
			if (cb_setVolume_D == null)
				cb_setVolume_D = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPD_V) n_SetVolume_D);
			return cb_setVolume_D;
		}

		static void n_SetVolume_D (IntPtr jnienv, IntPtr native__this, double volume)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.AudioTrack> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
