...
namespace Org.Webrtc {
	...
	public partial class IceCandidate : global::Java.Lang.Object {
		...
		public unsafe IceCandidate (string? sdpMid, int sdpMLineIndex, string? sdp) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			IntPtr native_sdpMid = JNIEnv.NewString ((string?)sdpMid);
			IntPtr native_sdp = JNIEnv.NewString ((string?)sdp);
			try {
