...
namespace Org.Webrtc {
	...
	public partial class GlShader : global::Java.Lang.Object {
		...
		public unsafe GlShader (string? vertexSource, string? fragmentSource) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			IntPtr native_vertexSource = JNIEnv.NewString ((string?)vertexSource);
			IntPtr native_fragmentSource = JNIEnv.NewString ((string?)fragmentSource);
			try {
...
#pragma warning disable 0169
		static Delegate GetGetAttribLocation_Ljava_lang_String_Handler ()
		{
			if (cb_getAttribLocation_Ljava_lang_String_ == null)
				cb_getAttribLocation_Ljava_lang_String_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPL_I) n_GetAttribLocation_Ljava_lang_String_);
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.GlShader> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning disable 0169
		static Delegate GetGetUniformLocation_Ljava_lang_String_Handler ()
		{
			if (cb_getUniformLocation_Ljava_lang_String_ == null)
				cb_getUniformLocation_Ljava_lang_String_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPL_I) n_GetUniformLocation_Ljava_lang_String_);
...
#pragma warning disable 0169
		static Delegate GetSetVertexAttribArray_Ljava_lang_String_IILjava_nio_FloatBuffer_Handler ()
		{
			if (cb_setVertexAttribArray_Ljava_lang_String_IILjava_nio_FloatBuffer_ == null)
				cb_setVertexAttribArray_Ljava_lang_String_IILjava_nio_FloatBuffer_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPLIIL_V) n_SetVertexAttribArray_Ljava_lang_String_IILjava_nio_FloatBuffer_);
		...
		static void n_SetVertexAttribArray_Ljava_lang_String_IILjava_nio_FloatBuffer_ (IntPtr jnienv, IntPtr native__this, IntPtr native_label, int dimension, int stride, IntPtr native_buffer)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.GlShader> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
			var label = JNIEnv.GetString (native_label, JniHandleOwnership.DoNotTransfer);
			var buffer = global::Java.Lang.Object.GetObject<global::Java.Nio.FloatBuffer> (native_buffer, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		static Delegate GetSetVertexAttribArray_Ljava_lang_String_ILjava_nio_FloatBuffer_Handler ()
		{
			if (cb_setVertexAttribArray_Ljava_lang_String_ILjava_nio_FloatBuffer_ == null)
				cb_setVertexAttribArray_Ljava_lang_String_ILjava_nio_FloatBuffer_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPLIL_V) n_SetVertexAttribArray_Ljava_lang_String_ILjava_nio_FloatBuffer_);
...
#pragma warning disable 0169
		static Delegate GetUseProgramHandler ()
		{
			if (cb_useProgram == null)
				cb_useProgram = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_V) n_UseProgram);
