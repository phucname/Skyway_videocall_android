...
namespace Org.Webrtc {
	...
	public partial class RtpParameters : global::Java.Lang.Object {
		...
		public partial class Encoding : global::Java.Lang.Object {
			...
			// Metadata.xml XPath field reference: path="/api/package[@name='org.webrtc']/class[@name='RtpParameters.Encoding']/field[@name='adaptiveAudioPacketTime']"
			[Register ("adaptiveAudioPacketTime")]
			public bool AdaptiveAudioPacketTime {
				get {
					const string __id = "adaptiveAudioPacketTime.Z";
			...
			public unsafe Encoding (string? rid, bool active, global::Java.Lang.Double? scaleResolutionDownBy) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				...
				IntPtr native_rid = JNIEnv.NewString ((string?)rid);
				try {
...
#pragma warning disable 0169
			static Delegate GetGetEncryptedHandler ()
			{
				if (cb_getEncrypted == null)
					cb_getEncrypted = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_Z) n_GetEncrypted);
				return cb_getEncrypted;
			}

			static bool n_GetEncrypted (IntPtr jnienv, IntPtr native__this)
			{
				var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.RtpParameters.HeaderExtension> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning disable 0169
			...
			{
				if (cb_getCname == null)
					cb_getCname = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetCname);
				return cb_getCname;
			}

			static IntPtr n_GetCname (IntPtr jnienv, IntPtr native__this)
			{
				var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.RtpParameters.Rtcp> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning disable 0169
			static Delegate GetGetReducedSizeHandler ()
			{
				if (cb_getReducedSize == null)
					cb_getReducedSize = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_Z) n_GetReducedSize);
...
#pragma warning disable 0169
		static Delegate GetGetHeaderExtensionsHandler ()
		{
			if (cb_getHeaderExtensions == null)
				cb_getHeaderExtensions = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetHeaderExtensions);
			return cb_getHeaderExtensions;
		}

		static IntPtr n_GetHeaderExtensions (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.RtpParameters> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning disable 0169
		...
		{
			if (cb_getRtcp == null)
				cb_getRtcp = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetRtcp);
			return cb_getRtcp;
		}
