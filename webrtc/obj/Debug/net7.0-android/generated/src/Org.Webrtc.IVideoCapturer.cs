...
namespace Org.Webrtc {
	...
	public partial interface IVideoCapturer : IJavaObject, IJavaPeerable {
		bool IsScreencast {
			...
			[Register ("isScreencast", "()Z", "GetIsScreencastHandler:Org.Webrtc.IVideoCapturerInvoker, webrtc")]
			get; 
		}
		...
		[Register ("changeCaptureFormat", "(III)V", "GetChangeCaptureFormat_IIIHandler:Org.Webrtc.IVideoCapturerInvoker, webrtc")]
		...
		[Register ("dispose", "()V", "GetDisposeHandler:Org.Webrtc.IVideoCapturerInvoker, webrtc")]
		void Dispose ();
		...
		[Register ("initialize", "(Lorg/webrtc/SurfaceTextureHelper;Landroid/content/Context;Lorg/webrtc/CapturerObserver;)V", "GetInitialize_Lorg_webrtc_SurfaceTextureHelper_Landroid_content_Context_Lorg_webrtc_CapturerObserver_Handler:Org.Webrtc.IVideoCapturerInvoker, webrtc")]
		...
		[Register ("startCapture", "(III)V", "GetStartCapture_IIIHandler:Org.Webrtc.IVideoCapturerInvoker, webrtc")]
		...
		[Register ("stopCapture", "()V", "GetStopCaptureHandler:Org.Webrtc.IVideoCapturerInvoker, webrtc")]
		void StopCapture ();
