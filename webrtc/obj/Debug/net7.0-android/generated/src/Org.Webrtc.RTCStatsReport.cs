...
namespace Org.Webrtc {
	...
	public partial class RTCStatsReport : global::Java.Lang.Object {
		...
		public unsafe RTCStatsReport (long timestampUs, global::System.Collections.Generic.IDictionary<string, global::Org.Webrtc.RTCStats>? stats) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		static Delegate GetGetStatsMapHandler ()
		{
			if (cb_getStatsMap == null)
				cb_getStatsMap = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetStatsMap);
			return cb_getStatsMap;
		}

		static IntPtr n_GetStatsMap (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.RTCStatsReport> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning disable 0169
		static Delegate GetGetTimestampUsHandler ()
		{
			if (cb_getTimestampUs == null)
				cb_getTimestampUs = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_D) n_GetTimestampUs);
