...
#pragma warning disable 0169
		...
		{
			if (cb_enable_I == null)
				cb_enable_I = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPI_V) n_Enable_I);
			return cb_enable_I;
		}

		static void n_Enable_I (IntPtr jnienv, IntPtr native__this, int audioSession)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.Voiceengine.WebRtcAudioEffects> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning disable 0169
		...
		{
			if (cb_setAEC_Z == null)
				cb_setAEC_Z = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPZ_Z) n_SetAEC_Z);
			return cb_setAEC_Z;
		}
...
#pragma warning disable 0169
		...
		{
			if (cb_setNS_Z == null)
				cb_setNS_Z = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPZ_Z) n_SetNS_Z);
			return cb_setNS_Z;
		}
