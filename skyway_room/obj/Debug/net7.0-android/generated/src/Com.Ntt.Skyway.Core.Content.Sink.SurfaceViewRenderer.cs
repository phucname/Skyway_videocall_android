...
namespace Com.Ntt.Skyway.Core.Content.Sink
{
    ...
    public sealed partial class SurfaceViewRenderer : global::Android.Widget.FrameLayout, global::Com.Ntt.Skyway.Core.Content.Sink.IRenderer
    {
        ...
        public unsafe global::Org.Webrtc.SurfaceViewRenderer Sink
        {
            // Metadata.xml XPath method reference: path="/api/package[@name='com.ntt.skyway.core.content.sink']/class[@name='SurfaceViewRenderer']/method[@name='getSink' and count(parameter)=0]"
            [Register("getSink", "()Lorg/webrtc/SurfaceViewRenderer;", "")]
            get
            {
                const string __id = "getSink.()Lorg/webrtc/SurfaceViewRenderer;";
                try
                {
                    var __rm = _members.InstanceMethods.InvokeAbstractObjectMethod(__id, this, null);
                    return global::Java.Lang.Object.GetObject<global::Org.Webrtc.SurfaceViewRenderer>(__rm.Handle, JniHandleOwnership.TransferLocalRef)!;
                }
                finally
                {
                }
            }
            // Metadata.xml XPath method reference: path="/api/package[@name='com.ntt.skyway.core.content.sink']/class[@name='SurfaceViewRenderer']/method[@name='setSink' and count(parameter)=1 and parameter[1][@type='org.webrtc.SurfaceViewRenderer']]"
            [Register("setSink", "(Lorg/webrtc/SurfaceViewRenderer;)V", "")]
            set
            {
                const string __id = "setSink.(Lorg/webrtc/SurfaceViewRenderer;)V";
                try
                {
                    JniArgumentValue* __args = stackalloc JniArgumentValue[1];
        ...
        Org.Webrtc.IVideoSink IRenderer.Sink => throw new NotImplementedException();
