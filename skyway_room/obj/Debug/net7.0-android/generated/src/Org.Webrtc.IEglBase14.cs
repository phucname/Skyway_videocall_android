...
namespace Org.Webrtc {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='org.webrtc']/interface[@name='EglBase14']"
	[Register ("org/webrtc/EglBase14", "", "Org.Webrtc.IEglBase14Invoker")]
	public partial interface IEglBase14 : global::Org.Webrtc.IEglBase {
		// Metadata.xml XPath interface reference: path="/api/package[@name='org.webrtc']/interface[@name='EglBase14.Context']"
		[Register ("org/webrtc/EglBase14$Context", "", "Org.Webrtc.IEglBase14/IContextInvoker")]
		public partial interface IContext : global::Org.Webrtc.IEglBase.IContext {
			global::Android.Opengl.EGLContext? RawContext {
				// Metadata.xml XPath method reference: path="/api/package[@name='org.webrtc']/interface[@name='EglBase14.Context']/method[@name='getRawContext' and count(parameter)=0]"
				[Register ("getRawContext", "()Landroid/opengl/EGLContext;", "GetGetRawContextHandler:Org.Webrtc.IEglBase14/IContextInvoker, skyway_room")]
				get; 
			}

		}

		[global::Android.Runtime.Register ("org/webrtc/EglBase14$Context", DoNotGenerateAcw=true)]
		internal partial class IContextInvoker : global::Java.Lang.Object, IContext {
			static readonly JniPeerMembers _members = new XAPeerMembers ("org/webrtc/EglBase14$Context", typeof (IContextInvoker));
			...
			static IntPtr Validate (IntPtr handle)
			{
				if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
					throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'org.webrtc.EglBase14.Context'.");
				return handle;
			}
...
#pragma warning disable 0169
			...
			{
				var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.IEglBase14.IContext> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
				return JNIEnv.ToLocalJniHandle (__this.RawContext);
			}
#pragma warning restore 0169

			IntPtr id_getRawContext;
			public unsafe global::Android.Opengl.EGLContext? RawContext {
				get {
					if (id_getRawContext == IntPtr.Zero)
						id_getRawContext = JNIEnv.GetMethodID (class_ref, "getRawContext", "()Landroid/opengl/EGLContext;");
					return global::Java.Lang.Object.GetObject<global::Android.Opengl.EGLContext> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_getRawContext), JniHandleOwnership.TransferLocalRef);
				}
			}
...
#pragma warning restore 0169
	...
	[global::Android.Runtime.Register ("org/webrtc/EglBase14", DoNotGenerateAcw=true)]
	internal partial class IEglBase14Invoker : global::Java.Lang.Object, IEglBase14 {
		static readonly JniPeerMembers _members = new XAPeerMembers ("org/webrtc/EglBase14", typeof (IEglBase14Invoker));
		...
		public static IEglBase14? GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<IEglBase14> (handle, transfer);
		}

		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'org.webrtc.EglBase14'.");
			return handle;
		}
		...
		public IEglBase14Invoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
			IntPtr local_ref = JNIEnv.GetObjectClass (((global::Java.Lang.Object) this).Handle);
			this.class_ref = JNIEnv.NewGlobalRef (local_ref);
			JNIEnv.DeleteLocalRef (local_ref);
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.IEglBase14> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
