...
namespace Org.Webrtc {
	...
	public partial interface ISdpObserver : IJavaObject, IJavaPeerable {
		...
		[Register ("onCreateFailure", "(Ljava/lang/String;)V", "GetOnCreateFailure_Ljava_lang_String_Handler:Org.Webrtc.ISdpObserverInvoker, skyway_room")]
		...
		[Register ("onCreateSuccess", "(Lorg/webrtc/SessionDescription;)V", "GetOnCreateSuccess_Lorg_webrtc_SessionDescription_Handler:Org.Webrtc.ISdpObserverInvoker, skyway_room")]
		...
		[Register ("onSetFailure", "(Ljava/lang/String;)V", "GetOnSetFailure_Ljava_lang_String_Handler:Org.Webrtc.ISdpObserverInvoker, skyway_room")]
		...
		[Register ("onSetSuccess", "()V", "GetOnSetSuccessHandler:Org.Webrtc.ISdpObserverInvoker, skyway_room")]
		void OnSetSuccess ();

	}

	[global::Android.Runtime.Register ("org/webrtc/SdpObserver", DoNotGenerateAcw=true)]
	internal partial class ISdpObserverInvoker : global::Java.Lang.Object, ISdpObserver {
		static readonly JniPeerMembers _members = new XAPeerMembers ("org/webrtc/SdpObserver", typeof (ISdpObserverInvoker));
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'org.webrtc.SdpObserver'.");
			return handle;
		}
...
#pragma warning disable 0169
		static Delegate GetOnCreateFailure_Ljava_lang_String_Handler ()
		{
			if (cb_onCreateFailure_Ljava_lang_String_ == null)
				cb_onCreateFailure_Ljava_lang_String_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPL_V) n_OnCreateFailure_Ljava_lang_String_);
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.ISdpObserver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning restore 0169
		...
		public unsafe void OnCreateFailure (string? p0)
		{
			...
			JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_onCreateFailure_Ljava_lang_String_, __args);
...
#pragma warning disable 0169
		static Delegate GetOnCreateSuccess_Lorg_webrtc_SessionDescription_Handler ()
		{
			if (cb_onCreateSuccess_Lorg_webrtc_SessionDescription_ == null)
				cb_onCreateSuccess_Lorg_webrtc_SessionDescription_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPL_V) n_OnCreateSuccess_Lorg_webrtc_SessionDescription_);
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.ISdpObserver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
			var p0 = global::Java.Lang.Object.GetObject<global::Org.Webrtc.SessionDescription> (native_p0, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		static Delegate GetOnSetFailure_Ljava_lang_String_Handler ()
		{
			if (cb_onSetFailure_Ljava_lang_String_ == null)
				cb_onSetFailure_Ljava_lang_String_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPL_V) n_OnSetFailure_Ljava_lang_String_);
...
#pragma warning restore 0169
		...
		public unsafe void OnSetFailure (string? p0)
		{
			...
			JValue* __args = stackalloc JValue [1];
			__args [0] = new JValue (native_p0);
			JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_onSetFailure_Ljava_lang_String_, __args);
			JNIEnv.DeleteLocalRef (native_p0);
		}
...
#pragma warning disable 0169
		static Delegate GetOnSetSuccessHandler ()
		{
			if (cb_onSetSuccess == null)
				cb_onSetSuccess = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_V) n_OnSetSuccess);
...
#pragma warning restore 0169
		...
		public unsafe void OnSetSuccess ()
		{
			...
			JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_onSetSuccess);
		}
