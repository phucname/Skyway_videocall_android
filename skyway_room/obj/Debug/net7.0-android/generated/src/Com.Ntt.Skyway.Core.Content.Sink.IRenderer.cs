...
namespace Com.Ntt.Skyway.Core.Content.Sink {
	...
	public partial interface IRenderer : IJavaObject, IJavaPeerable {
		bool Setup {
			...
			[Register ("isSetup", "()Z", "GetIsSetupHandler:Com.Ntt.Skyway.Core.Content.Sink.IRendererInvoker, skyway_room")]
			get; 
			...
			[Register ("setSetup", "(Z)V", "GetSetSetup_ZHandler:Com.Ntt.Skyway.Core.Content.Sink.IRendererInvoker, skyway_room")]
			set; 
		}

		global::Org.Webrtc.IVideoSink Sink {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.ntt.skyway.core.content.sink']/interface[@name='Renderer']/method[@name='getSink' and count(parameter)=0]"
			[Register ("getSink", "()Lorg/webrtc/VideoSink;", "GetGetSinkHandler:Com.Ntt.Skyway.Core.Content.Sink.IRendererInvoker, skyway_room")]
			get; 
		}
		...
		[Register ("dispose", "()V", "GetDisposeHandler:Com.Ntt.Skyway.Core.Content.Sink.IRendererInvoker, skyway_room")]
		void Dispose ();
...
#pragma warning restore 0169
		...
		static Delegate? cb_getSink;
#pragma warning disable 0169
		static Delegate GetGetSinkHandler ()
		{
			if (cb_getSink == null)
				cb_getSink = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetSink);
			return cb_getSink;
		}

		static IntPtr n_GetSink (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Ntt.Skyway.Core.Content.Sink.IRenderer> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning restore 0169
		...
		IntPtr id_getSink;
		public unsafe global::Org.Webrtc.IVideoSink Sink {
			get {
				if (id_getSink == IntPtr.Zero)
					id_getSink = JNIEnv.GetMethodID (class_ref, "getSink", "()Lorg/webrtc/VideoSink;");
				return global::Java.Lang.Object.GetObject<global::Org.Webrtc.IVideoSink> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_getSink), JniHandleOwnership.TransferLocalRef)!;
			}
		}
