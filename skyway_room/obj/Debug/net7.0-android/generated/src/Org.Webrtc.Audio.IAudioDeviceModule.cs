...
namespace Org.Webrtc.Audio {
	...
	public partial interface IAudioDeviceModule : IJavaObject, IJavaPeerable {
		long NativeAudioDeviceModulePointer {
			...
			[Register ("getNativeAudioDeviceModulePointer", "()J", "GetGetNativeAudioDeviceModulePointerHandler:Org.Webrtc.Audio.IAudioDeviceModuleInvoker, skyway_room")]
			get; 
		}
		...
		[Register ("release", "()V", "GetReleaseHandler:Org.Webrtc.Audio.IAudioDeviceModuleInvoker, skyway_room")]
		void Release ();
		...
		[Register ("setMicrophoneMute", "(Z)V", "GetSetMicrophoneMute_ZHandler:Org.Webrtc.Audio.IAudioDeviceModuleInvoker, skyway_room")]
		...
		[Register ("setSpeakerMute", "(Z)V", "GetSetSpeakerMute_ZHandler:Org.Webrtc.Audio.IAudioDeviceModuleInvoker, skyway_room")]
	...
	internal partial class IAudioDeviceModuleInvoker : global::Java.Lang.Object, IAudioDeviceModule {
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'org.webrtc.audio.AudioDeviceModule'.");
			return handle;
		}
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.Audio.IAudioDeviceModule> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
