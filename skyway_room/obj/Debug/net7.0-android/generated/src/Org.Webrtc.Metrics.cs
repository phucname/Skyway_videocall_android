...
namespace Org.Webrtc {
	...
	public partial class Metrics : global::Java.Lang.Object {
		...
		public partial class HistogramInfo : global::Java.Lang.Object {
			...
			[Register (".ctor", "(III)V", "")]
			public unsafe HistogramInfo (int min, int max, int bucketCount) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
...
#pragma warning disable 0169
			static Delegate GetAddSample_IIHandler ()
			{
				if (cb_addSample_II == null)
					cb_addSample_II = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPII_V) n_AddSample_II);
				return cb_addSample_II;
			}

			static void n_AddSample_II (IntPtr jnienv, IntPtr native__this, int value, int numEvents)
			{
				var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.Metrics.HistogramInfo> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
