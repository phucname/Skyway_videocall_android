...
namespace Org.Webrtc {
	...
	public partial class VideoFrame : global::Java.Lang.Object, global::Org.Webrtc.IRefCounted {
		...
		public partial interface IBuffer : global::Org.Webrtc.IRefCounted {
			private static readonly JniPeerMembers _members = new XAPeerMembers ("org/webrtc/VideoFrame$Buffer", typeof (IBuffer), isInterface: true);
			...
			int Height {
				...
				[Register ("getHeight", "()I", "GetGetHeightHandler:Org.Webrtc.VideoFrame/IBufferInvoker, skyway_room")]
				get; 
			}
			...
			int Width {
				...
				[Register ("getWidth", "()I", "GetGetWidthHandler:Org.Webrtc.VideoFrame/IBufferInvoker, skyway_room")]
				get; 
			}

			private static Delegate? cb_getBufferType;
#pragma warning disable 0169
			private static Delegate GetGetBufferTypeHandler ()
			{
				if (cb_getBufferType == null)
					cb_getBufferType = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_I) n_GetBufferType);
				return cb_getBufferType;
			}

			private static int n_GetBufferType (IntPtr jnienv, IntPtr native__this)
			{
				var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.VideoFrame.IBuffer> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
				return __this.BufferType;
			}
#pragma warning restore 0169

			virtual unsafe int BufferType {
				// Metadata.xml XPath method reference: path="/api/package[@name='org.webrtc']/interface[@name='VideoFrame.Buffer']/method[@name='getBufferType' and count(parameter)=0]"
				[Register ("getBufferType", "()I", "GetGetBufferTypeHandler:Org.Webrtc.VideoFrame/IBuffer, skyway_room")]
				get {
					const string __id = "getBufferType.()I";
					try {
			...
			[Register ("cropAndScale", "(IIIIII)Lorg/webrtc/VideoFrame$Buffer;", "GetCropAndScale_IIIIIIHandler:Org.Webrtc.VideoFrame/IBufferInvoker, skyway_room")]
			...
			[Register ("release", "()V", "GetReleaseHandler:Org.Webrtc.VideoFrame/IBufferInvoker, skyway_room")]
			void Release ();
			...
			[Register ("retain", "()V", "GetRetainHandler:Org.Webrtc.VideoFrame/IBufferInvoker, skyway_room")]
			void Retain ();
			...
			[Register ("toI420", "()Lorg/webrtc/VideoFrame$I420Buffer;", "GetToI420Handler:Org.Webrtc.VideoFrame/IBufferInvoker, skyway_room")]
		...
		internal partial class IBufferInvoker : global::Java.Lang.Object, IBuffer {
			...
			static IntPtr Validate (IntPtr handle)
			{
				if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
					throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'org.webrtc.VideoFrame.Buffer'.");
				return handle;
			}
...
#pragma warning restore 0169
		...
		public partial interface II420Buffer : global::Org.Webrtc.VideoFrame.IBuffer {
			private static readonly JniPeerMembers _members = new XAPeerMembers ("org/webrtc/VideoFrame$I420Buffer", typeof (II420Buffer), isInterface: true);
			...
			global::Java.Nio.ByteBuffer? DataU {
				...
				[Register ("getDataU", "()Ljava/nio/ByteBuffer;", "GetGetDataUHandler:Org.Webrtc.VideoFrame/II420BufferInvoker, skyway_room")]
				get; 
			}
			...
			global::Java.Nio.ByteBuffer? DataV {
				...
				[Register ("getDataV", "()Ljava/nio/ByteBuffer;", "GetGetDataVHandler:Org.Webrtc.VideoFrame/II420BufferInvoker, skyway_room")]
				get; 
			}
			...
			global::Java.Nio.ByteBuffer? DataY {
				...
				[Register ("getDataY", "()Ljava/nio/ByteBuffer;", "GetGetDataYHandler:Org.Webrtc.VideoFrame/II420BufferInvoker, skyway_room")]
				get; 
			}
			...
			int StrideU {
				...
				[Register ("getStrideU", "()I", "GetGetStrideUHandler:Org.Webrtc.VideoFrame/II420BufferInvoker, skyway_room")]
				get; 
			}
			...
			int StrideV {
				...
				[Register ("getStrideV", "()I", "GetGetStrideVHandler:Org.Webrtc.VideoFrame/II420BufferInvoker, skyway_room")]
				get; 
			}
			...
			int StrideY {
				...
				[Register ("getStrideY", "()I", "GetGetStrideYHandler:Org.Webrtc.VideoFrame/II420BufferInvoker, skyway_room")]
				get; 
			}
...
#pragma warning disable 0169
			...
			private static int n_GetBufferType (IntPtr jnienv, IntPtr native__this)
			{
				var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.VideoFrame.II420Buffer> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
				return __this.BufferType;
			}
#pragma warning restore 0169

			virtual unsafe int BufferType {
				// Metadata.xml XPath method reference: path="/api/package[@name='org.webrtc']/interface[@name='VideoFrame.I420Buffer']/method[@name='getBufferType' and count(parameter)=0]"
				[Register ("getBufferType", "()I", "GetGetBufferTypeHandler:Org.Webrtc.VideoFrame/II420Buffer, skyway_room")]
				get {
					const string __id = "getBufferType.()I";
					try {
						var __rm = _members.InstanceMethods.InvokeVirtualInt32Method (__id, this, null);
		...
		internal partial class II420BufferInvoker : global::Java.Lang.Object, II420Buffer {
			...
			{
				if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
					throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'org.webrtc.VideoFrame.I420Buffer'.");
				return handle;
			}
...
#pragma warning disable 0169
			...
			{
				if (cb_getDataU == null)
					cb_getDataU = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetDataU);
				return cb_getDataU;
			}
...
#pragma warning disable 0169
			...
			{
				if (cb_getDataV == null)
					cb_getDataV = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetDataV);
				return cb_getDataV;
			}
...
#pragma warning disable 0169
			...
			{
				if (cb_getDataY == null)
					cb_getDataY = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetDataY);
				return cb_getDataY;
			}
...
#pragma warning disable 0169
			static Delegate GetGetStrideUHandler ()
			{
				if (cb_getStrideU == null)
					cb_getStrideU = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_I) n_GetStrideU);
...
#pragma warning disable 0169
			static Delegate GetGetStrideVHandler ()
			{
				if (cb_getStrideV == null)
					cb_getStrideV = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_I) n_GetStrideV);
...
#pragma warning disable 0169
			static Delegate GetGetStrideYHandler ()
			{
				if (cb_getStrideY == null)
					cb_getStrideY = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_I) n_GetStrideY);
...
#pragma warning restore 0169
		...
		public partial interface ITextureBuffer : global::Org.Webrtc.VideoFrame.IBuffer {
			int TextureId {
				...
				[Register ("getTextureId", "()I", "GetGetTextureIdHandler:Org.Webrtc.VideoFrame/ITextureBufferInvoker, skyway_room")]
				get; 
			}
			...
			global::Android.Graphics.Matrix? TransformMatrix {
				...
				[Register ("getTransformMatrix", "()Landroid/graphics/Matrix;", "GetGetTransformMatrixHandler:Org.Webrtc.VideoFrame/ITextureBufferInvoker, skyway_room")]
				get; 
			}
			...
			[Register ("getType", "()Lorg/webrtc/VideoFrame$TextureBuffer$Type;", "GetGetTypeHandler:Org.Webrtc.VideoFrame/ITextureBufferInvoker, skyway_room")]
			global::Org.Webrtc.VideoFrame.ITextureBuffer.Type? GetType ();
			...
			public sealed partial class Type : global::Java.Lang.Enum {
				...
				[Register ("OES")]
				public static global::Org.Webrtc.VideoFrame.ITextureBuffer.Type? Oes {
					get {
						const string __id = "OES.Lorg/webrtc/VideoFrame$TextureBuffer$Type;";

						var __v = _members.StaticFields.GetObjectValue (__id);
						return global::Java.Lang.Object.GetObject<global::Org.Webrtc.VideoFrame.ITextureBuffer.Type> (__v.Handle, JniHandleOwnership.TransferLocalRef);
					}
				}
				...
				[Register ("RGB")]
				public static global::Org.Webrtc.VideoFrame.ITextureBuffer.Type? Rgb {
					get {
				...
				static readonly JniPeerMembers _members = new XAPeerMembers ("org/webrtc/VideoFrame$TextureBuffer$Type", typeof (Type));
				...
				public static unsafe global::Org.Webrtc.VideoFrame.ITextureBuffer.Type? ValueOf (string? name)
				{
					...
					try {
						...
						return global::Java.Lang.Object.GetObject<global::Org.Webrtc.VideoFrame.ITextureBuffer.Type> (__rm.Handle, JniHandleOwnership.TransferLocalRef);
					} finally {
				...
				public static unsafe global::Org.Webrtc.VideoFrame.ITextureBuffer.Type[]? Values ()
				{
					const string __id = "values.()[Lorg/webrtc/VideoFrame$TextureBuffer$Type;";
					try {
						var __rm = _members.StaticMethods.InvokeObjectMethod (__id, null);
						return (global::Org.Webrtc.VideoFrame.ITextureBuffer.Type[]?) JNIEnv.GetArray (__rm.Handle, JniHandleOwnership.TransferLocalRef, typeof (global::Org.Webrtc.VideoFrame.ITextureBuffer.Type));
					} finally {
					}
				}
		...
		internal partial class ITextureBufferInvoker : global::Java.Lang.Object, ITextureBuffer {
			...
			{
				if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
					throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'org.webrtc.VideoFrame.TextureBuffer'.");
				return handle;
			}
...
#pragma warning disable 0169
			...
			{
				var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.VideoFrame.ITextureBuffer> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning disable 0169
			static Delegate GetGetTransformMatrixHandler ()
			{
				if (cb_getTransformMatrix == null)
					cb_getTransformMatrix = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetTransformMatrix);
...
#pragma warning restore 0169
			...
			IntPtr id_getType;
			public unsafe global::Org.Webrtc.VideoFrame.ITextureBuffer.Type? GetType ()
			{
				if (id_getType == IntPtr.Zero)
					id_getType = JNIEnv.GetMethodID (class_ref, "getType", "()Lorg/webrtc/VideoFrame$TextureBuffer$Type;");
				return global::Java.Lang.Object.GetObject<global::Org.Webrtc.VideoFrame.ITextureBuffer.Type> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_getType), JniHandleOwnership.TransferLocalRef);
			}
...
#pragma warning restore 0169
		...
		public unsafe VideoFrame (global::Org.Webrtc.VideoFrame.IBuffer? buffer, int rotation, long timestampNs) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.VideoFrame> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning disable 0169
		static Delegate GetGetRotatedHeightHandler ()
		{
			if (cb_getRotatedHeight == null)
				cb_getRotatedHeight = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_I) n_GetRotatedHeight);
...
#pragma warning disable 0169
		static Delegate GetGetRotatedWidthHandler ()
		{
			if (cb_getRotatedWidth == null)
				cb_getRotatedWidth = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_I) n_GetRotatedWidth);
...
#pragma warning disable 0169
		static Delegate GetGetTimestampNsHandler ()
		{
			if (cb_getTimestampNs == null)
				cb_getTimestampNs = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_J) n_GetTimestampNs);
