...
namespace Org.Webrtc {
	...
	public partial class RtpTransceiver : global::Java.Lang.Object {
		...
		public sealed partial class RtpTransceiverInit : global::Java.Lang.Object {
			...
			[Register (".ctor", "()V", "")]
			public unsafe RtpTransceiverInit () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				const string __id = "()V";
			...
			public unsafe RtpTransceiverInit (global::Org.Webrtc.RtpTransceiver.RtpTransceiverDirection? direction) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
			...
			public unsafe RtpTransceiverInit (global::Org.Webrtc.RtpTransceiver.RtpTransceiverDirection? direction, global::System.Collections.Generic.IList<string>? streamIds) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
			...
			public unsafe RtpTransceiverInit (global::Org.Webrtc.RtpTransceiver.RtpTransceiverDirection? direction, global::System.Collections.Generic.IList<string>? streamIds, global::System.Collections.Generic.IList<global::Org.Webrtc.RtpParameters.Encoding>? sendEncodings) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				...
				try {
					...
					global::System.GC.KeepAlive (direction);
					global::System.GC.KeepAlive (streamIds);
					global::System.GC.KeepAlive (sendEncodings);
				}
			}
		...
		[Register (".ctor", "(J)V", "")]
		protected unsafe RtpTransceiver (long nativeRtpTransceiver) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		static Delegate GetGetCurrentDirectionHandler ()
		{
			if (cb_getCurrentDirection == null)
				cb_getCurrentDirection = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetCurrentDirection);
			return cb_getCurrentDirection;
		}

		static IntPtr n_GetCurrentDirection (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.RtpTransceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning disable 0169
		static Delegate GetGetMediaTypeHandler ()
		{
			if (cb_getMediaType == null)
				cb_getMediaType = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetMediaType);
...
#pragma warning disable 0169
		...
		{
			if (cb_getMid == null)
				cb_getMid = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetMid);
			return cb_getMid;
		}
...
#pragma warning disable 0169
		static Delegate GetGetReceiverHandler ()
		{
			if (cb_getReceiver == null)
				cb_getReceiver = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetReceiver);
...
#pragma warning disable 0169
		static Delegate GetGetSenderHandler ()
		{
			if (cb_getSender == null)
				cb_getSender = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetSender);
			return cb_getSender;
		}
...
#pragma warning disable 0169
		static Delegate GetSetDirection_Lorg_webrtc_RtpTransceiver_RtpTransceiverDirection_Handler ()
		{
			if (cb_setDirection_Lorg_webrtc_RtpTransceiver_RtpTransceiverDirection_ == null)
				cb_setDirection_Lorg_webrtc_RtpTransceiver_RtpTransceiverDirection_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPL_Z) n_SetDirection_Lorg_webrtc_RtpTransceiver_RtpTransceiverDirection_);
			return cb_setDirection_Lorg_webrtc_RtpTransceiver_RtpTransceiverDirection_;
		}

		static bool n_SetDirection_Lorg_webrtc_RtpTransceiver_RtpTransceiverDirection_ (IntPtr jnienv, IntPtr native__this, IntPtr native_rtpTransceiverDirection)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.RtpTransceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
			var rtpTransceiverDirection = global::Java.Lang.Object.GetObject<global::Org.Webrtc.RtpTransceiver.RtpTransceiverDirection> (native_rtpTransceiverDirection, JniHandleOwnership.DoNotTransfer);
			bool __ret = __this.SetDirection (rtpTransceiverDirection);
			return __ret;
		}
#pragma warning restore 0169
		...
		[Register ("setDirection", "(Lorg/webrtc/RtpTransceiver$RtpTransceiverDirection;)Z", "GetSetDirection_Lorg_webrtc_RtpTransceiver_RtpTransceiverDirection_Handler")]
		public virtual unsafe bool SetDirection (global::Org.Webrtc.RtpTransceiver.RtpTransceiverDirection? rtpTransceiverDirection)
		{
			const string __id = "setDirection.(Lorg/webrtc/RtpTransceiver$RtpTransceiverDirection;)Z";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [1];
				__args [0] = new JniArgumentValue ((rtpTransceiverDirection == null) ? IntPtr.Zero : ((global::Java.Lang.Object) rtpTransceiverDirection).Handle);
				var __rm = _members.InstanceMethods.InvokeVirtualBooleanMethod (__id, this, __args);
				return __rm;
			} finally {
				global::System.GC.KeepAlive (rtpTransceiverDirection);
			}
		}
...
#pragma warning disable 0169
		static Delegate GetStopInternalHandler ()
		{
			if (cb_stopInternal == null)
				cb_stopInternal = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_V) n_StopInternal);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.webrtc']/class[@name='RtpTransceiver']/method[@name='stopInternal' and count(parameter)=0]"
		[Register ("stopInternal", "()V", "GetStopInternalHandler")]
		public virtual unsafe void StopInternal ()
		{
			const string __id = "stopInternal.()V";
			try {
				_members.InstanceMethods.InvokeVirtualVoidMethod (__id, this, null);
			} finally {
			}
		...
		static Delegate? cb_stopStandard;
#pragma warning disable 0169
		static Delegate GetStopStandardHandler ()
		{
			if (cb_stopStandard == null)
				cb_stopStandard = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_V) n_StopStandard);
			return cb_stopStandard;
		}

		static void n_StopStandard (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.RtpTransceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
			__this.StopStandard ();
		}
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.webrtc']/class[@name='RtpTransceiver']/method[@name='stopStandard' and count(parameter)=0]"
		[Register ("stopStandard", "()V", "GetStopStandardHandler")]
		public virtual unsafe void StopStandard ()
		{
			const string __id = "stopStandard.()V";
			try {
				_members.InstanceMethods.InvokeVirtualVoidMethod (__id, this, null);
			} finally {
			}
