...
namespace Org.Webrtc {
	...
	public partial interface IAudioDecoderFactoryFactory : IJavaObject, IJavaPeerable {
		...
		[Register ("createNativeAudioDecoderFactory", "()J", "GetCreateNativeAudioDecoderFactoryHandler:Org.Webrtc.IAudioDecoderFactoryFactoryInvoker, skyway_room")]
	...
	internal partial class IAudioDecoderFactoryFactoryInvoker : global::Java.Lang.Object, IAudioDecoderFactoryFactory {
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'org.webrtc.AudioDecoderFactoryFactory'.");
			return handle;
		}
...
#pragma warning disable 0169
		static Delegate GetCreateNativeAudioDecoderFactoryHandler ()
		{
			if (cb_createNativeAudioDecoderFactory == null)
				cb_createNativeAudioDecoderFactory = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_J) n_CreateNativeAudioDecoderFactory);
			return cb_createNativeAudioDecoderFactory;
		}

		static long n_CreateNativeAudioDecoderFactory (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.IAudioDecoderFactoryFactory> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
