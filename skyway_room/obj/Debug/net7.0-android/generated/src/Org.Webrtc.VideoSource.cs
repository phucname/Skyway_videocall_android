...
namespace Org.Webrtc {
	...
	public partial class VideoSource : global::Org.Webrtc.MediaSource {
		...
		public partial class AspectRatio : global::Java.Lang.Object {
			...
			[Register (".ctor", "(II)V", "")]
			public unsafe AspectRatio (int width, int height) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
		...
		[Register (".ctor", "(J)V", "")]
		public unsafe VideoSource (long nativeSource) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		static Delegate GetGetCapturerObserverHandler ()
		{
			if (cb_getCapturerObserver == null)
				cb_getCapturerObserver = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetCapturerObserver);
			return cb_getCapturerObserver;
		}

		static IntPtr n_GetCapturerObserver (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.VideoSource> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning disable 0169
		static Delegate GetAdaptOutputFormat_IIIHandler ()
		{
			if (cb_adaptOutputFormat_III == null)
				cb_adaptOutputFormat_III = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPIII_V) n_AdaptOutputFormat_III);
...
#pragma warning disable 0169
		static Delegate GetAdaptOutputFormat_IIIIIHandler ()
		{
			if (cb_adaptOutputFormat_IIIII == null)
				cb_adaptOutputFormat_IIIII = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPIIIII_V) n_AdaptOutputFormat_IIIII);
...
#pragma warning disable 0169
		static Delegate GetAdaptOutputFormat_Lorg_webrtc_VideoSource_AspectRatio_Ljava_lang_Integer_Lorg_webrtc_VideoSource_AspectRatio_Ljava_lang_Integer_Ljava_lang_Integer_Handler ()
		{
			if (cb_adaptOutputFormat_Lorg_webrtc_VideoSource_AspectRatio_Ljava_lang_Integer_Lorg_webrtc_VideoSource_AspectRatio_Ljava_lang_Integer_Ljava_lang_Integer_ == null)
				cb_adaptOutputFormat_Lorg_webrtc_VideoSource_AspectRatio_Ljava_lang_Integer_Lorg_webrtc_VideoSource_AspectRatio_Ljava_lang_Integer_Ljava_lang_Integer_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPLLLLL_V) n_AdaptOutputFormat_Lorg_webrtc_VideoSource_AspectRatio_Ljava_lang_Integer_Lorg_webrtc_VideoSource_AspectRatio_Ljava_lang_Integer_Ljava_lang_Integer_);
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.VideoSource> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
			var targetLandscapeAspectRatio = global::Java.Lang.Object.GetObject<global::Org.Webrtc.VideoSource.AspectRatio> (native_targetLandscapeAspectRatio, JniHandleOwnership.DoNotTransfer);
			var maxLandscapePixelCount = global::Java.Lang.Object.GetObject<global::Java.Lang.Integer> (native_maxLandscapePixelCount, JniHandleOwnership.DoNotTransfer);
			var targetPortraitAspectRatio = global::Java.Lang.Object.GetObject<global::Org.Webrtc.VideoSource.AspectRatio> (native_targetPortraitAspectRatio, JniHandleOwnership.DoNotTransfer);
			var maxPortraitPixelCount = global::Java.Lang.Object.GetObject<global::Java.Lang.Integer> (native_maxPortraitPixelCount, JniHandleOwnership.DoNotTransfer);
			var maxFps = global::Java.Lang.Object.GetObject<global::Java.Lang.Integer> (native_maxFps, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe void AdaptOutputFormat (global::Org.Webrtc.VideoSource.AspectRatio? targetLandscapeAspectRatio, global::Java.Lang.Integer? maxLandscapePixelCount, global::Org.Webrtc.VideoSource.AspectRatio? targetPortraitAspectRatio, global::Java.Lang.Integer? maxPortraitPixelCount, global::Java.Lang.Integer? maxFps)
		{
			...
			try {
				...
				global::System.GC.KeepAlive (targetLandscapeAspectRatio);
				global::System.GC.KeepAlive (maxLandscapePixelCount);
				global::System.GC.KeepAlive (targetPortraitAspectRatio);
				global::System.GC.KeepAlive (maxPortraitPixelCount);
				global::System.GC.KeepAlive (maxFps);
			}
		}
...
#pragma warning disable 0169
		static Delegate GetSetIsScreencast_ZHandler ()
		{
			if (cb_setIsScreencast_Z == null)
				cb_setIsScreencast_Z = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPZ_V) n_SetIsScreencast_Z);
...
#pragma warning disable 0169
		static Delegate GetSetVideoProcessor_Lorg_webrtc_VideoProcessor_Handler ()
		{
			if (cb_setVideoProcessor_Lorg_webrtc_VideoProcessor_ == null)
				cb_setVideoProcessor_Lorg_webrtc_VideoProcessor_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPL_V) n_SetVideoProcessor_Lorg_webrtc_VideoProcessor_);
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.VideoSource> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
			var newVideoProcessor = (global::Org.Webrtc.IVideoProcessor?)global::Java.Lang.Object.GetObject<global::Org.Webrtc.IVideoProcessor> (native_newVideoProcessor, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe void SetVideoProcessor (global::Org.Webrtc.IVideoProcessor? newVideoProcessor)
		{
			...
			try {
				...
				global::System.GC.KeepAlive (newVideoProcessor);
			}
		}
