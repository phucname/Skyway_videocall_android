...
namespace Org.Webrtc {
	...
	public partial interface INativePeerConnectionFactory : IJavaObject, IJavaPeerable {
		...
		[Register ("createNativePeerConnection", "()J", "GetCreateNativePeerConnectionHandler:Org.Webrtc.INativePeerConnectionFactoryInvoker, skyway_room")]
	...
	internal partial class INativePeerConnectionFactoryInvoker : global::Java.Lang.Object, INativePeerConnectionFactory {
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'org.webrtc.NativePeerConnectionFactory'.");
			return handle;
		}
...
#pragma warning disable 0169
		static Delegate GetCreateNativePeerConnectionHandler ()
		{
			if (cb_createNativePeerConnection == null)
				cb_createNativePeerConnection = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_J) n_CreateNativePeerConnection);
			return cb_createNativePeerConnection;
		}

		static long n_CreateNativePeerConnection (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.INativePeerConnectionFactory> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
