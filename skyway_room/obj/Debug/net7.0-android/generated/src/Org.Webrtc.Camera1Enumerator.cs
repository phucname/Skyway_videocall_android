...
namespace Org.Webrtc {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.webrtc']/class[@name='Camera1Enumerator']"
	[global::Android.Runtime.Register ("org/webrtc/Camera1Enumerator", DoNotGenerateAcw=true)]
	public partial class Camera1Enumerator : global::Java.Lang.Object, global::Org.Webrtc.ICameraEnumerator {
		static readonly JniPeerMembers _members = new XAPeerMembers ("org/webrtc/Camera1Enumerator", typeof (Camera1Enumerator));
		...
		protected Camera1Enumerator (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.webrtc']/class[@name='Camera1Enumerator']/constructor[@name='Camera1Enumerator' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe Camera1Enumerator () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.webrtc']/class[@name='Camera1Enumerator']/constructor[@name='Camera1Enumerator' and count(parameter)=1 and parameter[1][@type='boolean']]"
		[Register (".ctor", "(Z)V", "")]
		public unsafe Camera1Enumerator (bool captureToTexture) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				__args [0] = new JniArgumentValue (captureToTexture);
...
#pragma warning disable 0169
		static Delegate GetCreateCapturer_Ljava_lang_String_Lorg_webrtc_CameraVideoCapturer_CameraEventsHandler_Handler ()
		{
			if (cb_createCapturer_Ljava_lang_String_Lorg_webrtc_CameraVideoCapturer_CameraEventsHandler_ == null)
				cb_createCapturer_Ljava_lang_String_Lorg_webrtc_CameraVideoCapturer_CameraEventsHandler_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPLL_L) n_CreateCapturer_Ljava_lang_String_Lorg_webrtc_CameraVideoCapturer_CameraEventsHandler_);
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.Camera1Enumerator> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
			var deviceName = JNIEnv.GetString (native_deviceName, JniHandleOwnership.DoNotTransfer);
			var eventsHandler = (global::Org.Webrtc.ICameraVideoCapturer.ICameraEventsHandler?)global::Java.Lang.Object.GetObject<global::Org.Webrtc.ICameraVideoCapturer.ICameraEventsHandler> (native_eventsHandler, JniHandleOwnership.DoNotTransfer);
			IntPtr __ret = JNIEnv.ToLocalJniHandle (__this.CreateCapturer (deviceName, eventsHandler));
			return __ret;
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='org.webrtc']/class[@name='Camera1Enumerator']/method[@name='createCapturer' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='org.webrtc.CameraVideoCapturer.CameraEventsHandler']]"
		...
		public virtual unsafe global::Org.Webrtc.ICameraVideoCapturer? CreateCapturer (string? deviceName, global::Org.Webrtc.ICameraVideoCapturer.ICameraEventsHandler? eventsHandler)
		{
...
#pragma warning disable 0169
		static Delegate GetGetDeviceNamesHandler ()
		{
			if (cb_getDeviceNames == null)
				cb_getDeviceNames = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetDeviceNames);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.webrtc']/class[@name='Camera1Enumerator']/method[@name='getDeviceNames' and count(parameter)=0]"
...
#pragma warning disable 0169
		static Delegate GetGetSupportedFormats_Ljava_lang_String_Handler ()
		{
			if (cb_getSupportedFormats_Ljava_lang_String_ == null)
				cb_getSupportedFormats_Ljava_lang_String_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPL_L) n_GetSupportedFormats_Ljava_lang_String_);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.webrtc']/class[@name='Camera1Enumerator']/method[@name='getSupportedFormats' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning disable 0169
		static Delegate GetIsBackFacing_Ljava_lang_String_Handler ()
		{
			if (cb_isBackFacing_Ljava_lang_String_ == null)
				cb_isBackFacing_Ljava_lang_String_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPL_Z) n_IsBackFacing_Ljava_lang_String_);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.webrtc']/class[@name='Camera1Enumerator']/method[@name='isBackFacing' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning disable 0169
		static Delegate GetIsFrontFacing_Ljava_lang_String_Handler ()
		{
			if (cb_isFrontFacing_Ljava_lang_String_ == null)
				cb_isFrontFacing_Ljava_lang_String_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPL_Z) n_IsFrontFacing_Ljava_lang_String_);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.webrtc']/class[@name='Camera1Enumerator']/method[@name='isFrontFacing' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
