...
namespace Org.Webrtc {
	...
	public partial class SessionDescription : global::Java.Lang.Object {
		...
		public sealed partial class Type : global::Java.Lang.Enum {
			...
			// Metadata.xml XPath field reference: path="/api/package[@name='org.webrtc']/class[@name='SessionDescription.Type']/field[@name='ROLLBACK']"
			[Register ("ROLLBACK")]
			public static global::Org.Webrtc.SessionDescription.Type? Rollback {
				get {
					const string __id = "ROLLBACK.Lorg/webrtc/SessionDescription$Type;";
			...
			public static unsafe global::Org.Webrtc.SessionDescription.Type? FromCanonicalForm (string? canonical)
			{
				...
				IntPtr native_canonical = JNIEnv.NewString ((string?)canonical);
				try {
		...
		public unsafe SessionDescription (global::Org.Webrtc.SessionDescription.Type? type, string? description) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
