...
namespace Com.Ntt.Skyway.Plugin.SfuBot {
	...
	public sealed partial class Forwarding : global::Java.Lang.Object {
		...
		public unsafe global::Com.Ntt.Skyway.Core.Channel.IChannel Channel {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.ntt.skyway.plugin.sfuBot']/class[@name='Forwarding']/method[@name='getChannel' and count(parameter)=0]"
		...
		public unsafe global::Com.Ntt.Skyway.Core.Channel.IPublication OriginPublication {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.ntt.skyway.plugin.sfuBot']/class[@name='Forwarding']/method[@name='getOriginPublication' and count(parameter)=0]"
			[Register ("getOriginPublication", "()Lcom/ntt/skyway/core/channel/Publication;", "")]
			get {
				const string __id = "getOriginPublication.()Lcom/ntt/skyway/core/channel/Publication;";
				try {
					var __rm = _members.InstanceMethods.InvokeNonvirtualObjectMethod (__id, this, null);
		...
		public unsafe global::Com.Ntt.Skyway.Core.Channel.IPublication RelayingPublication {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.ntt.skyway.plugin.sfuBot']/class[@name='Forwarding']/method[@name='getRelayingPublication' and count(parameter)=0]"
			[Register ("getRelayingPublication", "()Lcom/ntt/skyway/core/channel/Publication;", "")]
			get {
				const string __id = "getRelayingPublication.()Lcom/ntt/skyway/core/channel/Publication;";
				try {
					var __rm = _members.InstanceMethods.InvokeNonvirtualObjectMethod (__id, this, null);
					return global::Java.Lang.Object.GetObject<global::Com.Ntt.Skyway.Core.Channel.IPublication> (__rm.Handle, JniHandleOwnership.TransferLocalRef)!;
				} finally {
