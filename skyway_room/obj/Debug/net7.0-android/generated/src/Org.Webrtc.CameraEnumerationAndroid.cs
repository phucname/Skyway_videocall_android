	...
	public partial class CameraEnumerationAndroid : global::Java.Lang.Object {
		...
		public partial class CaptureFormat : global::Java.Lang.Object {
			...
			public partial class FramerateRange : global::Java.Lang.Object {
				...
				[Register (".ctor", "(II)V", "")]
				public unsafe FramerateRange (int min, int max) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
				{
			...
			public unsafe CaptureFormat (int width, int height, int minFramerate, int maxFramerate) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
			...
			public unsafe CaptureFormat (int width, int height, global::Org.Webrtc.CameraEnumerationAndroid.CaptureFormat.FramerateRange? framerate) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				...
				try {
					...
					global::System.GC.KeepAlive (framerate);
				}
			}
...
#pragma warning disable 0169
			static Delegate GetFrameSizeHandler ()
			{
				if (cb_frameSize == null)
					cb_frameSize = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_I) n_FrameSize);
				return cb_frameSize;
			}

			static int n_FrameSize (IntPtr jnienv, IntPtr native__this)
			{
				var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.CameraEnumerationAndroid.CaptureFormat> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning restore 0169
		...
		[Register (".ctor", "()V", "")]
		public unsafe CameraEnumerationAndroid () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
		...
		public static unsafe global::Org.Webrtc.CameraEnumerationAndroid.CaptureFormat.FramerateRange? GetClosestSupportedFramerateRange (global::System.Collections.Generic.IList<global::Org.Webrtc.CameraEnumerationAndroid.CaptureFormat.FramerateRange>? supportedFramerates, int requestedFps)
		{
			...
			try {
				...
				global::System.GC.KeepAlive (supportedFramerates);
			}
		}
		...
		public static unsafe global::Org.Webrtc.Size? GetClosestSupportedSize (global::System.Collections.Generic.IList<global::Org.Webrtc.Size>? supportedSizes, int requestedWidth, int requestedHeight)
		{
			...
			try {
				...
				global::System.GC.KeepAlive (supportedSizes);
			}
		}
