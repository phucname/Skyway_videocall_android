...
namespace Com.Ntt.Skyway.Room.Sfu {
	...
	public sealed partial class SFURoom : global::Com.Ntt.Skyway.Room.Room {
		...
		public sealed partial class Companion : global::Java.Lang.Object {
			...
			// Metadata.xml XPath constructor reference: path="/api/package[@name='com.ntt.skyway.room.sfu']/class[@name='SFURoom.Companion']/constructor[@name='SFURoom.Companion' and count(parameter)=1 and parameter[1][@type='kotlin.jvm.internal.DefaultConstructorMarker']]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.ntt.skyway.room.sfu']/class[@name='SFURoom.Companion']/method[@name='create' and count(parameter)=3 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='kotlin.coroutines.Continuation&lt;? super com.ntt.skyway.room.sfu.SFURoom&gt;']]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.ntt.skyway.room.sfu']/class[@name='SFURoom.Companion']/method[@name='findOrCreate' and count(parameter)=3 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='kotlin.coroutines.Continuation&lt;? super com.ntt.skyway.room.sfu.SFURoom&gt;']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ntt.skyway.room.sfu']/class[@name='SFURoom']/method[@name='create' and count(parameter)=3 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='kotlin.coroutines.Continuation&lt;? super com.ntt.skyway.room.sfu.SFURoom&gt;']]"
		[Register ("create", "(Ljava/lang/String;Ljava/lang/String;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ntt.skyway.room.sfu']/class[@name='SFURoom']/method[@name='find' and count(parameter)=3 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='kotlin.coroutines.Continuation&lt;? super com.ntt.skyway.room.sfu.SFURoom&gt;']]"
		[Register ("find", "(Ljava/lang/String;Ljava/lang/String;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ntt.skyway.room.sfu']/class[@name='SFURoom']/method[@name='findOrCreate' and count(parameter)=3 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='kotlin.coroutines.Continuation&lt;? super com.ntt.skyway.room.sfu.SFURoom&gt;']]"
		[Register ("findOrCreate", "(Ljava/lang/String;Ljava/lang/String;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ntt.skyway.room.sfu']/class[@name='SFURoom']/method[@name='join' and count(parameter)=2 and parameter[1][@type='com.ntt.skyway.room.member.RoomMember.Init'] and parameter[2][@type='kotlin.coroutines.Continuation&lt;? super com.ntt.skyway.room.sfu.LocalSFURoomMember&gt;']]"
