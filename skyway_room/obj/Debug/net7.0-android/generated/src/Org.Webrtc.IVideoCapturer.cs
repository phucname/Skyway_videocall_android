...
namespace Org.Webrtc {
	...
	public partial interface IVideoCapturer : IJavaObject, IJavaPeerable {
		bool IsScreencast {
			...
			[Register ("isScreencast", "()Z", "GetIsScreencastHandler:Org.Webrtc.IVideoCapturerInvoker, skyway_room")]
			get; 
		}
		...
		[Register ("changeCaptureFormat", "(III)V", "GetChangeCaptureFormat_IIIHandler:Org.Webrtc.IVideoCapturerInvoker, skyway_room")]
		...
		[Register ("dispose", "()V", "GetDisposeHandler:Org.Webrtc.IVideoCapturerInvoker, skyway_room")]
		void Dispose ();
		...
		[Register ("initialize", "(Lorg/webrtc/SurfaceTextureHelper;Landroid/content/Context;Lorg/webrtc/CapturerObserver;)V", "GetInitialize_Lorg_webrtc_SurfaceTextureHelper_Landroid_content_Context_Lorg_webrtc_CapturerObserver_Handler:Org.Webrtc.IVideoCapturerInvoker, skyway_room")]
		...
		[Register ("startCapture", "(III)V", "GetStartCapture_IIIHandler:Org.Webrtc.IVideoCapturerInvoker, skyway_room")]
		...
		[Register ("stopCapture", "()V", "GetStopCaptureHandler:Org.Webrtc.IVideoCapturerInvoker, skyway_room")]
		void StopCapture ();
	...
	internal partial class IVideoCapturerInvoker : global::Java.Lang.Object, IVideoCapturer {
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'org.webrtc.VideoCapturer'.");
			return handle;
		}
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.IVideoCapturer> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
