...
namespace Org.Webrtc {
	...
	public partial interface ICapturerObserver : IJavaObject, IJavaPeerable {
		...
		[Register ("onCapturerStarted", "(Z)V", "GetOnCapturerStarted_ZHandler:Org.Webrtc.ICapturerObserverInvoker, skyway_room")]
		...
		[Register ("onCapturerStopped", "()V", "GetOnCapturerStoppedHandler:Org.Webrtc.ICapturerObserverInvoker, skyway_room")]
		...
		[Register ("onFrameCaptured", "(Lorg/webrtc/VideoFrame;)V", "GetOnFrameCaptured_Lorg_webrtc_VideoFrame_Handler:Org.Webrtc.ICapturerObserverInvoker, skyway_room")]
	...
	internal partial class ICapturerObserverInvoker : global::Java.Lang.Object, ICapturerObserver {
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'org.webrtc.CapturerObserver'.");
			return handle;
		}
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.ICapturerObserver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
