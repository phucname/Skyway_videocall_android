...
namespace Org.Webrtc {
	...
	public partial interface INativeLibraryLoader : IJavaObject, IJavaPeerable {
		...
		[Register ("load", "(Ljava/lang/String;)Z", "GetLoad_Ljava_lang_String_Handler:Org.Webrtc.INativeLibraryLoaderInvoker, skyway_room")]
		bool Load (string? p0);
	...
	internal partial class INativeLibraryLoaderInvoker : global::Java.Lang.Object, INativeLibraryLoader {
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'org.webrtc.NativeLibraryLoader'.");
			return handle;
		}
...
#pragma warning disable 0169
		static Delegate GetLoad_Ljava_lang_String_Handler ()
		{
			if (cb_load_Ljava_lang_String_ == null)
				cb_load_Ljava_lang_String_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPL_Z) n_Load_Ljava_lang_String_);
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.INativeLibraryLoader> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning restore 0169
		...
		public unsafe bool Load (string? p0)
		{
			...
			var __ret = JNIEnv.CallBooleanMethod (((global::Java.Lang.Object) this).Handle, id_load_Ljava_lang_String_, __args);
