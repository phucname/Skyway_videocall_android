...
namespace Org.Webrtc {
	...
	public partial class ScreenCapturerAndroid : global::Java.Lang.Object, global::Org.Webrtc.IVideoCapturer, global::Org.Webrtc.IVideoSink {
		...
		public unsafe ScreenCapturerAndroid (global::Android.Content.Intent? mediaProjectionPermissionResultData, global::Android.Media.Projection.MediaProjection.Callback? mediaProjectionCallback) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				global::System.GC.KeepAlive (mediaProjectionCallback);
			}
		}
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.ScreenCapturerAndroid> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning restore 0169
		...
		static Delegate? cb_getMediaProjection;
#pragma warning disable 0169
		static Delegate GetGetMediaProjectionHandler ()
		{
			if (cb_getMediaProjection == null)
				cb_getMediaProjection = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetMediaProjection);
			return cb_getMediaProjection;
		}

		static IntPtr n_GetMediaProjection (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.ScreenCapturerAndroid> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
			return JNIEnv.ToLocalJniHandle (__this.MediaProjection);
		}
#pragma warning restore 0169

		public virtual unsafe global::Android.Media.Projection.MediaProjection? MediaProjection {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.webrtc']/class[@name='ScreenCapturerAndroid']/method[@name='getMediaProjection' and count(parameter)=0]"
			[Register ("getMediaProjection", "()Landroid/media/projection/MediaProjection;", "GetGetMediaProjectionHandler")]
			get {
				const string __id = "getMediaProjection.()Landroid/media/projection/MediaProjection;";
				try {
...
#pragma warning disable 0169
		static Delegate GetGetNumCapturedFramesHandler ()
		{
			if (cb_getNumCapturedFrames == null)
				cb_getNumCapturedFrames = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_J) n_GetNumCapturedFrames);
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.ScreenCapturerAndroid> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
			var surfaceTextureHelper = global::Java.Lang.Object.GetObject<global::Org.Webrtc.SurfaceTextureHelper> (native_surfaceTextureHelper, JniHandleOwnership.DoNotTransfer);
			...
			var capturerObserver = (global::Org.Webrtc.ICapturerObserver?)global::Java.Lang.Object.GetObject<global::Org.Webrtc.ICapturerObserver> (native_capturerObserver, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe void Initialize (global::Org.Webrtc.SurfaceTextureHelper? surfaceTextureHelper, global::Android.Content.Context? applicationContext, global::Org.Webrtc.ICapturerObserver? capturerObserver)
		{
			...
			try {
				...
				global::System.GC.KeepAlive (capturerObserver);
			}
		}
