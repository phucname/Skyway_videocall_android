...
namespace Org.Webrtc {
	...
	public partial interface INetworkControllerFactoryFactory : IJavaObject, IJavaPeerable {
		...
		[Register ("createNativeNetworkControllerFactory", "()J", "GetCreateNativeNetworkControllerFactoryHandler:Org.Webrtc.INetworkControllerFactoryFactoryInvoker, skyway_room")]
	...
	internal partial class INetworkControllerFactoryFactoryInvoker : global::Java.Lang.Object, INetworkControllerFactoryFactory {
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'org.webrtc.NetworkControllerFactoryFactory'.");
			return handle;
		}
...
#pragma warning disable 0169
		static Delegate GetCreateNativeNetworkControllerFactoryHandler ()
		{
			if (cb_createNativeNetworkControllerFactory == null)
				cb_createNativeNetworkControllerFactory = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_J) n_CreateNativeNetworkControllerFactory);
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.INetworkControllerFactoryFactory> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
