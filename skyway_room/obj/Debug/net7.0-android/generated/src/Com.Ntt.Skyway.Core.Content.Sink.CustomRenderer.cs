...
namespace Com.Ntt.Skyway.Core.Content.Sink {
	...
	public sealed partial class CustomRenderer : global::Java.Lang.Object, global::Com.Ntt.Skyway.Core.Content.Sink.IRenderer {
		...
		public unsafe global::Org.Webrtc.IVideoSink Sink {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.ntt.skyway.core.content.sink']/class[@name='CustomRenderer']/method[@name='getSink' and count(parameter)=0]"
			[Register ("getSink", "()Lorg/webrtc/VideoSink;", "")]
			get {
				const string __id = "getSink.()Lorg/webrtc/VideoSink;";
				try {
					var __rm = _members.InstanceMethods.InvokeAbstractObjectMethod (__id, this, null);
					return global::Java.Lang.Object.GetObject<global::Org.Webrtc.IVideoSink> (__rm.Handle, JniHandleOwnership.TransferLocalRef)!;
				} finally {
				}
			}
		}
