...
namespace Org.Webrtc {
	...
	public partial interface IRefCounted : IJavaObject, IJavaPeerable {
		...
		[Register ("release", "()V", "GetReleaseHandler:Org.Webrtc.IRefCountedInvoker, skyway_room")]
		void Release ();
		...
		[Register ("retain", "()V", "GetRetainHandler:Org.Webrtc.IRefCountedInvoker, skyway_room")]
		void Retain ();
	...
	internal partial class IRefCountedInvoker : global::Java.Lang.Object, IRefCounted {
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'org.webrtc.RefCounted'.");
			return handle;
		}
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.IRefCounted> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
			__this.Release ();
		}
