...
namespace Org.Webrtc {
	...
	public partial interface ISSLCertificateVerifier : IJavaObject, IJavaPeerable {
		...
		[Register ("verify", "([B)Z", "GetVerify_arrayBHandler:Org.Webrtc.ISSLCertificateVerifierInvoker, skyway_room")]
		bool Verify (byte[]? p0);
	...
	internal partial class ISSLCertificateVerifierInvoker : global::Java.Lang.Object, ISSLCertificateVerifier {
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'org.webrtc.SSLCertificateVerifier'.");
			return handle;
		}
...
#pragma warning disable 0169
		static Delegate GetVerify_arrayBHandler ()
		{
			if (cb_verify_arrayB == null)
				cb_verify_arrayB = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPL_Z) n_Verify_arrayB);
			return cb_verify_arrayB;
		}

		static bool n_Verify_arrayB (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.ISSLCertificateVerifier> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning restore 0169
		...
		public unsafe bool Verify (byte[]? p0)
		{
			...
			var __ret = JNIEnv.CallBooleanMethod (((global::Java.Lang.Object) this).Handle, id_verify_arrayB, __args);
			if (p0 != null) {
