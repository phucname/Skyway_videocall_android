...
namespace Org.Webrtc {
	...
	public partial class DataChannel : global::Java.Lang.Object {
		...
		public partial class Buffer : global::Java.Lang.Object {
			...
			public unsafe Buffer (global::Java.Nio.ByteBuffer? data, bool binary) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
		...
		public partial class Init : global::Java.Lang.Object {
			...
			[Register (".ctor", "()V", "")]
			public unsafe Init () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				const string __id = "()V";
		...
		public partial interface IObserver : IJavaObject, IJavaPeerable {
			...
			[Register ("onBufferedAmountChange", "(J)V", "GetOnBufferedAmountChange_JHandler:Org.Webrtc.DataChannel/IObserverInvoker, skyway_room")]
			...
			[Register ("onMessage", "(Lorg/webrtc/DataChannel$Buffer;)V", "GetOnMessage_Lorg_webrtc_DataChannel_Buffer_Handler:Org.Webrtc.DataChannel/IObserverInvoker, skyway_room")]
			...
			[Register ("onStateChange", "()V", "GetOnStateChangeHandler:Org.Webrtc.DataChannel/IObserverInvoker, skyway_room")]
			void OnStateChange ();
		...
		internal partial class IObserverInvoker : global::Java.Lang.Object, IObserver {
			...
			static IntPtr Validate (IntPtr handle)
			{
				if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
					throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'org.webrtc.DataChannel.Observer'.");
				return handle;
			}
...
#pragma warning disable 0169
			static Delegate GetOnBufferedAmountChange_JHandler ()
			{
				if (cb_onBufferedAmountChange_J == null)
					cb_onBufferedAmountChange_J = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPJ_V) n_OnBufferedAmountChange_J);
				return cb_onBufferedAmountChange_J;
			}

			static void n_OnBufferedAmountChange_J (IntPtr jnienv, IntPtr native__this, long p0)
			{
				var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.DataChannel.IObserver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning disable 0169
			static Delegate GetOnMessage_Lorg_webrtc_DataChannel_Buffer_Handler ()
			{
				if (cb_onMessage_Lorg_webrtc_DataChannel_Buffer_ == null)
					cb_onMessage_Lorg_webrtc_DataChannel_Buffer_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPL_V) n_OnMessage_Lorg_webrtc_DataChannel_Buffer_);
			...
			{
				var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.DataChannel.IObserver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
				var p0 = global::Java.Lang.Object.GetObject<global::Org.Webrtc.DataChannel.Buffer> (native_p0, JniHandleOwnership.DoNotTransfer);
				__this.OnMessage (p0);
			}
#pragma warning restore 0169
...
#pragma warning disable 0169
			static Delegate GetOnStateChangeHandler ()
			{
				if (cb_onStateChange == null)
					cb_onStateChange = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_V) n_OnStateChange);
...
#pragma warning restore 0169
		...
		[Register (".ctor", "(J)V", "")]
		public unsafe DataChannel (long nativeDataChannel) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		static Delegate GetBufferedAmountHandler ()
		{
			if (cb_bufferedAmount == null)
				cb_bufferedAmount = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_J) n_BufferedAmount);
			return cb_bufferedAmount;
		}

		static long n_BufferedAmount (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.DataChannel> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning disable 0169
		...
		{
			if (cb_id == null)
				cb_id = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_I) n_Id);
			return cb_id;
		}
...
#pragma warning disable 0169
		...
		{
			if (cb_label == null)
				cb_label = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_Label);
			return cb_label;
		}
...
#pragma warning disable 0169
		static Delegate GetRegisterObserver_Lorg_webrtc_DataChannel_Observer_Handler ()
		{
			if (cb_registerObserver_Lorg_webrtc_DataChannel_Observer_ == null)
				cb_registerObserver_Lorg_webrtc_DataChannel_Observer_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPL_V) n_RegisterObserver_Lorg_webrtc_DataChannel_Observer_);
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.DataChannel> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
			var observer = (global::Org.Webrtc.DataChannel.IObserver?)global::Java.Lang.Object.GetObject<global::Org.Webrtc.DataChannel.IObserver> (native_observer, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		static Delegate GetSend_Lorg_webrtc_DataChannel_Buffer_Handler ()
		{
			if (cb_send_Lorg_webrtc_DataChannel_Buffer_ == null)
				cb_send_Lorg_webrtc_DataChannel_Buffer_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPL_Z) n_Send_Lorg_webrtc_DataChannel_Buffer_);
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.DataChannel> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
			var buffer = global::Java.Lang.Object.GetObject<global::Org.Webrtc.DataChannel.Buffer> (native_buffer, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		...
		{
			if (cb_state == null)
				cb_state = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_InvokeState);
			return cb_state;
		}
...
#pragma warning disable 0169
		static Delegate GetUnregisterObserverHandler ()
		{
			if (cb_unregisterObserver == null)
				cb_unregisterObserver = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_V) n_UnregisterObserver);
