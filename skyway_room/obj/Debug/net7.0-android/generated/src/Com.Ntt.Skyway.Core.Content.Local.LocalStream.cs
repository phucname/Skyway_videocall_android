...
namespace Com.Ntt.Skyway.Core.Content.Local
{
	...
	public abstract partial class LocalStream : global::Com.Ntt.Skyway.Core.Content.Stream {
		...
		public unsafe global::Org.Webrtc.AudioTrack Track {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.ntt.skyway.core.content.local']/class[@name='LocalAudioStream']/method[@name='getTrack' and count(parameter)=0]"
			[Register ("getTrack", "()Lorg/webrtc/AudioTrack;", "")]
			get {
				const string __id = "getTrack.()Lorg/webrtc/AudioTrack;";
				try {
