...
#pragma warning disable 0169
			static Delegate GetCreateCryptoOptionsHandler ()
			{
				if (cb_createCryptoOptions == null)
					cb_createCryptoOptions = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_CreateCryptoOptions);
				return cb_createCryptoOptions;
			}

			static IntPtr n_CreateCryptoOptions (IntPtr jnienv, IntPtr native__this)
			{
				var __this = global::Java.Lang.Object.GetObject<global::Org.Webrtc.CryptoOptions.Builder> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning disable 0169
			static Delegate GetSetEnableAes128Sha1_32CryptoCipher_ZHandler ()
			{
				if (cb_setEnableAes128Sha1_32CryptoCipher_Z == null)
					cb_setEnableAes128Sha1_32CryptoCipher_Z = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPZ_L) n_SetEnableAes128Sha1_32CryptoCipher_Z);
...
#pragma warning disable 0169
			static Delegate GetSetEnableEncryptedRtpHeaderExtensions_ZHandler ()
			{
				if (cb_setEnableEncryptedRtpHeaderExtensions_Z == null)
					cb_setEnableEncryptedRtpHeaderExtensions_Z = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPZ_L) n_SetEnableEncryptedRtpHeaderExtensions_Z);
...
#pragma warning disable 0169
			static Delegate GetSetEnableGcmCryptoSuites_ZHandler ()
			{
				if (cb_setEnableGcmCryptoSuites_Z == null)
					cb_setEnableGcmCryptoSuites_Z = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPZ_L) n_SetEnableGcmCryptoSuites_Z);
...
#pragma warning disable 0169
			static Delegate GetSetRequireFrameEncryption_ZHandler ()
			{
				if (cb_setRequireFrameEncryption_Z == null)
					cb_setRequireFrameEncryption_Z = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPZ_L) n_SetRequireFrameEncryption_Z);
