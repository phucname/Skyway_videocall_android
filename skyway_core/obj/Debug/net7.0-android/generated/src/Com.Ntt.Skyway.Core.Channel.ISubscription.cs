...
namespace Com.Ntt.Skyway.Core.Channel {
	...
	public partial interface ISubscription : IJavaObject, IJavaPeerable {
		global::Com.Ntt.Skyway.Core.Channel.IChannel Channel {
			...
			[Register ("getChannel", "()Lcom/ntt/skyway/core/channel/Channel;", "GetGetChannelHandler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, skyway_core")]
			get; 
		}
		...
		global::Com.Ntt.Skyway.Core.Content.Stream.ContentType ContentType {
			...
			[Register ("getContentType", "()Lcom/ntt/skyway/core/content/Stream$ContentType;", "GetGetContentTypeHandler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, skyway_core")]
			get; 
		}
		...
		string Id {
			...
			[Register ("getId", "()Ljava/lang/String;", "GetGetIdHandler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, skyway_core")]
			get; 
		}
		...
		long NativePointer {
			...
			[Register ("getNativePointer", "()J", "GetGetNativePointerHandler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, skyway_core")]
			get; 
		}
		...
		string PreferredEncodingId {
			...
			[Register ("getPreferredEncodingId", "()Ljava/lang/String;", "GetGetPreferredEncodingIdHandler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, skyway_core")]
			get; 
		}
		...
		global::Com.Ntt.Skyway.Core.Channel.IPublication Publication {
			...
			[Register ("getPublication", "()Lcom/ntt/skyway/core/channel/Publication;", "GetGetPublicationHandler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, skyway_core")]
			get; 
		}
		...
		global::Com.Ntt.Skyway.Core.Content.WebRTCStats? Stats {
			...
			[Register ("getStats", "()Lcom/ntt/skyway/core/content/WebRTCStats;", "GetGetStatsHandler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, skyway_core")]
			get; 
		}
		...
		global::Com.Ntt.Skyway.Core.Content.Remote.RemoteStream? Stream {
			...
			[Register ("getStream", "()Lcom/ntt/skyway/core/content/remote/RemoteStream;", "GetGetStreamHandler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, skyway_core")]
			get; 
		}
		...
		global::Com.Ntt.Skyway.Core.Channel.Member.IMember Subscriber {
			...
			[Register ("getSubscriber", "()Lcom/ntt/skyway/core/channel/member/Member;", "GetGetSubscriberHandler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, skyway_core")]
			get; 
		}
		...
		[Register ("changePreferredEncoding", "(Ljava/lang/String;)V", "GetChangePreferredEncoding_Ljava_lang_String_Handler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, skyway_core")]
		...
		[Register ("getState", "()Lcom/ntt/skyway/core/channel/Subscription$State;", "GetGetStateHandler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, skyway_core")]
